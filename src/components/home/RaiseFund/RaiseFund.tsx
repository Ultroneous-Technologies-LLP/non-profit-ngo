...
export const RaiseFund: FC<RaiseFundProps> = ({
  ...
  >
    <div className="w-full md:col-start-1 md:col-end-1">
    ...
    <div className="flex items-center justify-center pb-8 md:col-start-2 md:col-end-2 md:row-start-1 md:row-end-3 md:justify-end md:pb-0">
      <Image
        alt={image.alt}
    ...
    <div className="flex flex-col items-center justify-center gap-5 md:col-start-1 md:col-end-1 md:flex-row md:items-start md:justify-start">
      <Link
        className="font-segoe-regular bg-primary-blue text-primary-yellow hover:text-primary-blue hover:border-primary-blue inline-block w-full rounded-full border border-transparent px-6.5 py-2.5 text-center text-sm/5 font-semibold transition-colors duration-500
      ...
      <Link
        className="font-segoe-regular text-primary-blue border-primary-blue hover:text-primary-blue hover:border-primary-blue inline-block w-full rounded-full border bg-transparent px-6.5 py-2.5 text-center text-sm/5 font-semibold transition-colors duration-500
